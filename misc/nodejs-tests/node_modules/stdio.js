...
module.exports = (function() {
    ...
    ////////// TCP Transport Lib
    var TCPIOLib = function(address, port, options) {
    ...
    util.inherits(TCPIOLib, EventEmitter);

    TCPIOLib.prototype.send = function(data) {
        this.sock.write(data);
    }

    TCPIOLib.prototype.start = function() {
        this.sock = new net.Socket();
        var base = this;
        this.sock.connect(this.port, this.address, function() {
            base.emit('open', base);
        });
